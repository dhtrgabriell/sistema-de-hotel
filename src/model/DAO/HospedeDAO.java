...
public class HospedeDAO implements InterfaceDAO<Hospede>{
    ...
    public Hospede Retrieve(int id) {
        ...
        String sqlInstrucao = "Select id, nome, fone, fone2, email, cep, logradouro, bairro, cidade, complemento, data_cadastro, cpf, rg, obs, status, usuario, senha, razao_social, cnpj, inscricao_estadual, contato from hospede where id = ?";
